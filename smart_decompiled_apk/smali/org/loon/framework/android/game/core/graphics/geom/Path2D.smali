...
.method public final contains(DD)Z
    ...
    .line 1927
    :cond_1
    iget v3, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->windingRule:I
...
.method final readObject(Ljava/io/ObjectInputStream;Z)V
    ...
    invoke-virtual {p0, v8}, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->setWindingRule(I)V
    :try_end_0
    ...
    iput-object v8, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->pointTypes:[B
    ...
    .line 2375
    check-cast v8, Lorg/loon/framework/android/game/core/graphics/geom/Path2D$Double;

    new-array v9, v3, [D

    iput-object v9, v8, Lorg/loon/framework/android/game/core/graphics/geom/Path2D$Double;->doubleCoords:[D
    ...
    .line 2377
    check-cast v8, Lorg/loon/framework/android/game/core/graphics/geom/Path2D$Float;

    new-array v9, v3, [F

    iput-object v9, v8, Lorg/loon/framework/android/game/core/graphics/geom/Path2D$Float;->floatCoords:[F
    ...
    invoke-virtual {p0, v8, v9}, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->needRoom(ZI)V
    ...
    .line 2454
    :goto_6
    iget-object v8, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->pointTypes:[B

    iget v9, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->numTypes:I

    add-int/lit8 v10, v9, 0x1

    iput v10, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->numTypes:I
    ...
    .line 2393
    .end local v2    # "isdbl":Z
    .end local v5    # "npoints":I
    .end local v6    # "segtype":B
    :sswitch_1
    const/4 v2, 0x0

    .line 2394
    .restart local v2    # "isdbl":Z
    const/4 v5, 0x1

    .line 2395
    .restart local v5    # "npoints":I
    const/4 v6, 0x1

    .line 2396
    .restart local v6    # "segtype":B
    goto :goto_3
    ...
    invoke-virtual {p0, v8, v9, v10, v11}, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->append(DD)V
    ...
    invoke-virtual {p0, v8, v9}, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->append(FF)V
...
.method final writeObject(Ljava/io/ObjectOutputStream;Z)V
    ...
    iget-object v2, v8, Lorg/loon/framework/android/game/core/graphics/geom/Path2D$Double;->doubleCoords:[D
    ...
    .local v3, "fCoords":[F
    :goto_0
    iget v6, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->numTypes:I
    ...
    .line 2303
    iget v8, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->numCoords:I

    invoke-virtual {p1, v8}, Ljava/io/ObjectOutputStream;->writeInt(I)V

    .line 2304
    iget v8, p0, Lorg/loon/framework/android/game/core/graphics/geom/Path2D;->windingRule:I
    ...
    .end local v2    # "dCoords":[D
    .end local v3    # "fCoords":[F
    .end local v4    # "i":I
    ...
    iget-object v3, v8, Lorg/loon/framework/android/game/core/graphics/geom/Path2D$Float;->floatCoords:[F

    .restart local v3    # "fCoords":[F
    move-object v2, v9

    .line 2294
    check-cast v2, [D

    .restart local v2    # "dCoords":[D
    goto :goto_0
